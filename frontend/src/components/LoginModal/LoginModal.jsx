...
const LoginModal = ({ setShowLogin }) => {
    ...
    <div className='login-modal'>
        <form onSubmit={onLogin} className='login-modal-container' action="">
            ...
            <div className="login-modal-input">
                ...
                <input name='email' onChange={onChangeHandler} value={data.email} type="email" placeholder='email@.com' required />
